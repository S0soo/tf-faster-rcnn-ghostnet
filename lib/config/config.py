...
# Network Parameters #
######################
tf.app.flags.DEFINE_string('network', "ghostnet", "The network to be used as backbone")

#######################
# Training Parameters #
#######################
tf.app.flags.DEFINE_float('weight_decay', 0.00005, "Weight decay, for regularization")
...
tf.app.flags.DEFINE_integer('step_size', 80000, "Step size for reducing the learning rate, currently only support one step")
...
tf.app.flags.DEFINE_integer('snapshot_iterations', 10000, "Iteration to take snapshot")
